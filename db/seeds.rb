...
review_11 = Review.create!(itinerary_id: itinerary_6.id, user_id: user_2/.id, rating: 4, content: "This itinerary was good but I found that the activities did not all fit together ! I loved the Opéra Garnier but I would have preferred to finish the evening with a more chic restaurant!")
